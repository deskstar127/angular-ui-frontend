...
(function(root, factory) {
	...
	$.extend(Selectize.prototype, {
		...
		setup: function() {
			...
			if (0 < parseInt(self.settings.extraHeight)) {
				self.extraHeight = parseInt(self.settings.extraHeight);
			}
		...
		open: function() {
			...
			self.positionDropdown();
			/* secondary call to apply dropdown-up if needed */
			self.refreshClasses();
		...
		positionDropdown: function() {
			...
			if (optDirection === 'auto') {
				var dropdownBottom = $control.offset().top + controlHeight + dropdownHeight - $(window).scrollTop() + self.extraHeight;
			...
			this.$dropdown.toggleClass('dropdown-up', self.isDropUp);
			this.$dropdown.css({
